...
##### Bilder:
![alt-text](https://github.com/luckyskeleton/wu1_wier/blob/master/assets/img/html.PNG " html kod med semikolon")

![alt-text](https://github.com/luckyskeleton/wu1_wier/blob/master/assets/img/htmlerror.PNG "html kod utan semikolon")
